...
public class OptionsWindow extends JFrame {
    ...
    public OptionsWindow(Course course) {
        ...
        //on closing , will write the new and additions updated with the previous list
    ...
    private void registerListeners(Course course) {
