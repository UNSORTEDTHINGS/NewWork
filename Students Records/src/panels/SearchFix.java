...
public class SearchFix extends JPanel {
    ...
    private final JTextField currentId,searchInput,currentName;
     ...
     */
    public SearchFix(Course course) {
    ...
    private void addListener(Course course) {
        //addActionListeners
